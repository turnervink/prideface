...
int *flags[] = {pansexual, gay, asexual, bisexual, trans, polysexual, nonbinary}; // Array of all flag colour arrays
int flag_segments[] = {3, 6, 4, 5, 5, 3, 4}; // Array of # of segments for each flag
